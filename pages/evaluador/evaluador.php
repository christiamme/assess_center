  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Mis Assessments</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
				<div class="box">
            <div class="box-body">
              <table id="tabla_assessments" class="table table-bordered table-striped">
                <thead>
	                <tr>
	                  <th>Fecha y Hora</th>
	                  <th>Evaluado</th>
...
<!-- REQUIRED JS SCRIPTS -->
	...
	<script src="evaluador.js" type="text/javascript"></script>
